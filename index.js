...
async function run() {
    try {
        ...
        const travelsCollection = database.collection("travelpost");
...
app.get('/', (req, res) => {
    res.send('Explore travel running');
})

app.listen(port, () => {
    console.log('Explore travel running', port)
})
// https://polar-ocean-68780.herokuapp.com/ | https://git.heroku.com/polar-ocean-68780.git